...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className="flex flex-col border-t border-primary-grey-200 bg-[#2c2c2c] text-white min-w-[227px] sticky left-0 h-[92%] max-sm:hidden select-none overflow-y-auto pb-20 rounded-xl">
